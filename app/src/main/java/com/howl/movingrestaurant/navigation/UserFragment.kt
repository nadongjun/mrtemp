...
import com.howl.movingrestaurant.EditActivity
import com.howl.movingrestaurant.LoginActivity
import com.howl.movingrestaurant.MainActivity
...
class UserFragment : Fragment(){
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        fragmentView?.edit_button?.setOnClickListener {
            val intent = Intent(getApplicationContext(), EditActivity::class.java)
    ...
    //auth?.currentUser?.uid 현재 로그인한 유저 정보
